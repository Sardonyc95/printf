...
/**
 * _printf - Function that prints output using Printf function
 ...
 * @buffer: input param (Array of chars)
 * @buff_ind: input param (Index at which to add next char, represents
 * the length).
 */
void print_buffer(char buffer[], int *buff_ind)
{

 ...
 * @is_negative: input param (Lista of arguments)
 * @ind: char types.
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width.
 ...
 * @ind: input param (Index at which the number starts on the buffer)
 * @buffer: Buffer
 * @flags: Flags
 * @width: width
 ...
 * @is_negative: input param (Number indicating if the num is negative)
 ...
 * @buffer: input param (Arrays of chars)
 * @ind: Index at which the number starts in the buffer
